...
const TreeCompensationChart = () => {
      ...
      async () => {
        ...
        treeCompensationLayer
          ...
          .then(async (featureReduction: any) => {
            ...
            layerView = await arcgisMap?.view.whenLayerView(
              treeCompensationLayer
            );
          })
          .catch((error) => {
  ...
  useEffect(() => {
    ...
    pieSeries.slices.template.events.on("click", (ev) => {
      ...
      arcgisMap?.whenLayerView(treeCompensationLayer).then((layerView: any) => {
        //chartLayerView = layerView;

        treeCompensationLayer.queryFeatures(query).then((results) => {
          ...
          treeCompensationLayer.queryExtent(queryExt).then((result) => {
            if (result.extent) {
