...
float evaluateAmbientOcclusion() { return 0.0; }`)}},15710:(e,t,a)=>{a.d(t,{E:()=>g});var o=a(67078),r=a(26917),i=a(59395),n=a(59046),s=a(90080),l=a(97808),c=a(55386),d=a(49399),u=a(87236),h=a(66763),m=a(37516),v=a(3799),p=a(86955),f=a(70367);function g(e,t){const{vertex:a,fragment:g,varyings:x}=e,{hasColorTexture:b,alphaDiscardMode:w}=t,y=b&&1!==w,{output:M,normalType:T,hasColorTextureTransform:C}=t;switch(M){case 2:(0,v.NB)(a,t),e.include(i.d),g.include(r.HQ,t),e.include(l.U,t),y&&g.uniforms.add(new f.N("tex",e=>e.texture)),a.main.add(p.H`vpos = getVertexInLocalOriginSpace();
...
forwardObjectAndLayerIdColor();`),e.include(m.S,t),g.main.add(p.H`
        ...
        ${10===M?p.H`outputObjectAndLayerIdColor();`:p.H`outputDepth(depth);`}`);break;case 3:{(0,v.NB)(a,t),e.include(i.d),e.include(n.Y,t),e.include(c.Mh,t),e.include(l.U,t),e.include(h.A,t),y&&g.uniforms.add(new f.N("tex",e=>e.texture)),2===T&&x.add("vPositionView","vec3",{invariant:!0});const o=0===T||1===T;a.main.add(p.H`
        ...
        fragColor = vec4(0.5 + 0.5 * normal, 1.0);`);break}case 9:(0,v.NB)(a,t),e.include(i.d),e.include(l.U,t),e.include(h.A,t),y&&g.uniforms.add(new f.N("tex",e=>e.texture)),a.main.add(p.H`vpos = getVertexInLocalOriginSpace();
vpos = subtractOrigin(vpos);
vpos = addVerticalOffset(vpos, localOrigin);
gl_Position = transformPosition(proj, view, vpos);
forwardTextureCoordinates();`),g.include(r.HQ,t),e.include(m.S,t),e.include(u.Q,t),g.main.add(p.H`
        ...
        ${(0,p.If)(y,p.H`vec4 texColor = texture(tex, ${C?"colorUV":"vuv0"});
                discardOrAdjustAlpha(texColor);`)}
        calculateOcclusionAndOutputHighlight();`)}}},22148:(e,t,a)=>{a.d(t,{K:()=>s});var o=a(85793),r=a(86955),i=a(72790),n=a(99362);function s(e,t){e.varyings.add("colorMixMode","int"),e.varyings.add("opacityMixMode","int"),e.vertex.uniforms.add(new i.c("symbolColorMixMode",e=>n.Um[e.colorMixMode])),t.hasSymbolColors?(e.vertex.include(o.WD),e.vertex.include(o.Y1),e.vertex.include(o.ML),e.attributes.add("symbolColor","vec4"),e.vertex.code.add(r.H`
...
return color;
  ...
  `)}},26719:(e,t,a)=>{a.d(t,{_:()=>d});var o=a(95352),r=a(72468),i=a(5517),n=a(86955),s=a(27374),l=a(70367),c=(a(78992),a(31432));c.Y;function d(e,t){const a=t.pbrMode,c=e.fragment;if(2!==a&&0!==a&&1!==a)return void c.code.add(n.H`void applyPBRFactors() {}`);if(0===a)return void c.code.add(n.H`void applyPBRFactors() {}
float getBakedOcclusion() { return 1.0; }`);if(2===a)return void c.code.add(n.H`vec3 mrr = vec3(0.0, 0.6, 0.2);
float occlusion = 1.0;
void applyPBRFactors() {}
float getBakedOcclusion() { return 1.0; }`);const{hasMetallicRoughnessTexture:d,hasMetallicRoughnessTextureTransform:u,hasOcclusionTexture:h,hasOcclusionTextureTransform:m,bindType:v}=t;(d||h)&&e.include(o.r,t),c.code.add(n.H`vec3 mrr;
float occlusion;`),d&&c.uniforms.add(1===v?new l.N("texMetallicRoughness",e=>e.textureMetallicRoughness):new s.o("texMetallicRoughness",e=>e.textureMetallicRoughness)),h&&c.uniforms.add(1===v?new l.N("texOcclusion",e=>e.textureOcclusion):new s.o("texOcclusion",e=>e.textureOcclusion)),c.uniforms.add(1===v?new i.t("mrrFactors",e=>e.mrrFactors):new r.W("mrrFactors",e=>e.mrrFactors)),c.code.add(n.H`
  ...
  `)}},27920:(e,t,a)=>{a.d(t,{r:()=>i});var o=a(4212),r=a(86955);function i(e,t){const a=e.fragment;switch(a.code.add(r.H`struct ShadingNormalParameters {
vec3 normalView;
vec3 viewDirection;
...
return gl_FrontFacing ? normalize(params.normalView) : normalize(-params.normalView);
}`);break;default:(0,o.Xb)(t.doubleSidedMode);case 3:}}},29228:(e,t,a)=>{a.d(t,{S:()=>m,b:()=>h});var o=a(73398),r=a(65058),i=a(56289),n=a(21390),s=a(86955),l=a(27374),c=a(70367),d=a(2687);const u=4;function h(){const e=new d.N5,t=e.fragment;e.include(o.c);const a=(u+1)/2,h=1/(2*a*a);return t.include(r.E),t.uniforms.add(new c.N("depthMap",e=>e.depthTexture),new l.o("tex",e=>e.colorTexture),new i.t("blurSize",e=>e.blurSize),new n.m("projScale",(e,t)=>{const a=t.camera.distance;return a>5e4?Math.max(0,e.projScale-(a-5e4)):e.projScale})),t.code.add(s.H`
  ...
  `),e.outputs.add("fragBlur","float"),t.main.add(s.H`
    ...
    fragBlur = b / w_total;`),e}const m=Object.freeze(Object.defineProperty({__proto__:null,build:h},Symbol.toStringTag,{value:"Module"}))},34260:(e,t,a)=>{a.d(t,{b:()=>i});var o=a(23148),r=a(86955);function i(e,t){t.snowCover&&(e.uniforms.add(new o.U("snowCover",e=>e.snowCover)).code.add(r.H`float getSnow(vec3 normal, vec3 groundNormal) {
...
}`))}},35249:(e,t,a)=>{a.d(t,{R:()=>A,b:()=>V});var o=a(62026),r=a(34981),i=a(26917),n=a(59395),s=a(35771),l=a(45937),c=a(85793),d=a(59046),u=a(22148),h=a(97808),m=a(54478),v=a(25530),p=a(15710),f=a(9365),g=a(66970),x=a(43557),b=a(42953),w=a(26719),y=a(51740),M=a(94192),T=a(66763),C=a(37516),S=a(77904),_=a(3799),H=a(5517),z=a(58350),N=a(21390),I=a(86955),O=a(70367),F=a(34260),E=a(99362),L=a(91911),R=a(2687),G=a(75569);function V(e){const t=new R.N5,{attributes:a,vertex:V,fragment:A,varyings:P}=t,{output:D,offsetBackfaces:B,pbrMode:j,snowCover:W,spherical:U}=e,k=1===j||2===j;if((0,_.NB)(V,e),a.add("position","vec3"),P.add("vpos","vec3",{invariant:!0}),t.include(T.A,e),t.include(l.B,e),t.include(v.Ge,e),t.include(M.Z,e),!(0,r.RN)(D))return t.include(p.E,e),t;(0,_.yu)(t.vertex,e),t.include(d.Y,e),t.include(n.d),B&&t.include(o.M),P.add("vNormalWorld","vec3"),P.add("localvpos","vec3",{invariant:!0}),t.include(h.U,e),t.include(u.K,e),t.include(s.v,e),t.include(m.c,e),V.include(c.WD),V.include(c.oF),V.uniforms.add(new z.E("externalColor",e=>e.externalColor,{supportsNaN:!0})),P.add("vcolorExt","vec4"),t.include(e.instancedDoublePrecision?y.G:y.Bz,e),V.main.add(I.H`
...
}`)}var i=a(36324);function n(e,t){e.include(i.p),1!==t.pbrMode&&2!==t.pbrMode&&5!==t.pbrMode&&6!==t.pbrMode||(e.code.add(o.H`float normalDistribution(float NdotH, float roughness)
{
...
}`)}},43557:(e,t,a)=>{a.d(t,{Gc:()=>i,O4:()=>n,Vt:()=>s});var o=a(84115),r=a(86955);function i(e){e.uniforms.add(new o.d("mainLightDirection",e=>e.lighting.mainLight.direction))}function n(e){e.uniforms.add(new o.d("mainLightIntensity",e=>e.lighting.mainLight.intensity))}function s(e){i(e.fragment),n(e.fragment),e.fragment.code.add(r.H`vec3 applyShading(vec3 shadingNormal, float shadow) {
float dotVal = clamp(dot(shadingNormal, mainLightDirection), 0.0, 1.0);
return mainLightIntensity * ((1.0 - shadow) * dotVal);
}`)}},45937:(e,t,a)=>{a.d(t,{B:()=>g});var o=a(86300),r=a(44680),i=a(13191),n=a(20664),s=a(9392),l=a(89299),c=a(3799),d=a(84115),u=a(86955),h=a(72106),m=a(43425),v=a(99643),p=a(31432);p.Y;const f=(0,r.vt)();function g(e,t){const{hasModelTransformation:a,instancedDoublePrecision:r,instanced:s,output:p,hasVertexTangents:g}=t;a&&(e.vertex.uniforms.add(new m.X("model",e=>e.modelTransformation??i.zK)),e.vertex.uniforms.add(new h.k("normalLocalOriginFromModel",e=>((0,o.Ge)(f,e.modelTransformation??i.zK),f)))),s&&r&&(e.attributes.add("instanceModelOriginHi","vec3"),e.attributes.add("instanceModelOriginLo","vec3"),e.attributes.add("instanceModel","mat3"),e.attributes.add("instanceModelNormal","mat3"));const b=e.vertex;r&&(b.include(l.u,t),b.uniforms.add(new d.d("viewOriginHi",e=>(0,v.Zo)((0,n.j)(x,e.camera.viewInverseTransposeMatrix[3],e.camera.viewInverseTransposeMatrix[7],e.camera.viewInverseTransposeMatrix[11]),x)),new d.d("viewOriginLo",e=>(0,v.jA)((0,n.j)(x,e.camera.viewInverseTransposeMatrix[3],e.camera.viewInverseTransposeMatrix[7],e.camera.viewInverseTransposeMatrix[11]),x)))),b.code.add(u.H`
    ...
    }`)}const x=(0,s.vt)()},48353:(e,t,a)=>{a.d(t,{O:()=>o,b:()=>r});const o=3e5,r=5e5},49399:(e,t,a)=>{a.d(t,{L:()=>r});var o=a(86955);function r(e,t){switch(t.output){case 4:case 5:case 6:case 7:e.fragment.code.add(o.H`float _calculateFragDepth(const in float depth) {
...
}`)}}},50819:(e,t,a)=>{a.d(t,{W:()=>d});var o=a(20664),r=a(9392),i=a(43047),n=a(55855),s=a(84115),l=a(51596),c=a(86955);function d(e,t){const a=e.fragment,r=void 0!==t.lightingSphericalHarmonicsOrder?t.lightingSphericalHarmonicsOrder:2;0===r?(a.uniforms.add(new s.d("lightingAmbientSH0",e=>{let{lighting:t}=e;return(0,o.j)(u,t.sh.r[0],t.sh.g[0],t.sh.b[0])})),a.code.add(c.H`vec3 calculateAmbientIrradiance(vec3 normal, float ambientOcclusion) {
vec3 ambientLight = 0.282095 * lightingAmbientSH0;
return ambientLight * (1.0 - ambientOcclusion);
}`)):1===r?(a.uniforms.add(new l.I("lightingAmbientSH_R",e=>{let{lighting:t}=e;return(0,i.s)(h,t.sh.r[0],t.sh.r[1],t.sh.r[2],t.sh.r[3])}),new l.I("lightingAmbientSH_G",e=>{let{lighting:t}=e;return(0,i.s)(h,t.sh.g[0],t.sh.g[1],t.sh.g[2],t.sh.g[3])}),new l.I("lightingAmbientSH_B",e=>{let{lighting:t}=e;return(0,i.s)(h,t.sh.b[0],t.sh.b[1],t.sh.b[2],t.sh.b[3])})),a.code.add(c.H`vec3 calculateAmbientIrradiance(vec3 normal, float ambientOcclusion) {
vec4 sh0 = vec4(
0.282095,
0.488603 * normal.x,
0.488603 * normal.z,
...
return ambientLight * (1.0 - ambientOcclusion);
}`)):2===r&&(a.uniforms.add(new s.d("lightingAmbientSH0",e=>{let{lighting:t}=e;return(0,o.j)(u,t.sh.r[0],t.sh.g[0],t.sh.b[0])}),new l.I("lightingAmbientSH_R1",e=>{let{lighting:t}=e;return(0,i.s)(h,t.sh.r[1],t.sh.r[2],t.sh.r[3],t.sh.r[4])}),new l.I("lightingAmbientSH_G1",e=>{let{lighting:t}=e;return(0,i.s)(h,t.sh.g[1],t.sh.g[2],t.sh.g[3],t.sh.g[4])}),new l.I("lightingAmbientSH_B1",e=>{let{lighting:t}=e;return(0,i.s)(h,t.sh.b[1],t.sh.b[2],t.sh.b[3],t.sh.b[4])}),new l.I("lightingAmbientSH_R2",e=>{let{lighting:t}=e;return(0,i.s)(h,t.sh.r[5],t.sh.r[6],t.sh.r[7],t.sh.r[8])}),new l.I("lightingAmbientSH_G2",e=>{let{lighting:t}=e;return(0,i.s)(h,t.sh.g[5],t.sh.g[6],t.sh.g[7],t.sh.g[8])}),new l.I("lightingAmbientSH_B2",e=>{let{lighting:t}=e;return(0,i.s)(h,t.sh.b[5],t.sh.b[6],t.sh.b[7],t.sh.b[8])})),a.code.add(c.H`vec3 calculateAmbientIrradiance(vec3 normal, float ambientOcclusion) {
vec3 ambientLight = 0.282095 * lightingAmbientSH0;
vec4 sh1 = vec4(
0.488603 * normal.x,
0.488603 * normal.z,
...
}`))}const u=(0,r.vt)(),h=(0,n.vt)()},51331:(e,t,a)=>{a.d(t,{S:()=>b,b:()=>f,g:()=>g});var o=a(19555),r=a(72745),i=a(73398),n=a(65058),s=a(27963),l=a(28450),c=a(95756),d=a(23148),u=a(21390),h=a(86955),m=a(70367),v=a(2687);const p=16;function f(){const e=new v.N5,t=e.fragment;return e.include(i.c),e.include(s.Ir),t.include(n.E),t.uniforms.add(new d.U("radius",e=>g(e.camera))).code.add(h.H`vec3 sphere[16] = vec3[16](
...
return fallOffFunction(vv, vn, 0.1);
    ...
    fragOcclusion = A;
  `),e}function g(e){return Math.max(10,20*e.computeScreenPixelSizeAtDist(Math.abs(4*e.relativeElevation)))}const x=(0,r.vt)(),b=Object.freeze(Object.defineProperty({__proto__:null,build:f,getRadius:g},Symbol.toStringTag,{value:"Module"}))},51740:(e,t,a)=>{a.d(t,{Bz:()=>w,G:()=>b});a(9392);var o=a(72412),r=a(34981),i=a(86955);function n(e,t){const a=(0,r.RN)(t.output)&&t.receiveShadows;a&&(0,o.o)(e,!0),e.vertex.code.add(i.H`
    void forwardLinearDepthToReadShadowMap() { ${(0,i.If)(a,"forwardLinearDepth(gl_Position.w);")} }
  `)}var s=a(51596),l=a(53908),c=a(87003);class d extends c.n{constructor(e,t,a,o){super(e,"mat4",2,(a,r,i,n)=>a.setUniformMatrices4fv(e,t(r,i,n),o),a)}}class u extends c.n{constructor(e,t,a,o){super(e,"mat4",1,(a,r,i)=>a.setUniformMatrices4fv(e,t(r,i),o),a)}}var h=a(31432);h.Y;function m(e){e.fragment.uniforms.add(new u("shadowMapMatrix",(e,t)=>t.shadowMap.getShadowMapMatrices(e.origin),4)),p(e)}function v(e){e.fragment.uniforms.add(new d("shadowMapMatrix",(e,t)=>t.shadowMap.getShadowMapMatrices(e.origin),4)),p(e)}function p(e){const{fragment:t}=e;t.uniforms.add(new s.I("cascadeDistances",e=>e.shadowMap.cascadeDistances),new l.W("numCascades",e=>e.shadowMap.numCascades)),t.code.add(i.H`const vec3 invalidShadowmapUVZ = vec3(0.0, 0.0, -1.0);
...
}`)):e.vertex.code.add(r.H`void forwardMetallicRoughnessUV(){}`)}},59046:(e,t,a)=>{a.d(t,{Y:()=>i});var o=a(4212),r=a(86955);function i(e,t){switch(e.fragment.code.add(r.H`vec3 screenDerivativeNormal(vec3 positionView) {
...
return normal;
}`);break;default:(0,o.Xb)(t.normalType);case 2:case 3:}}},61337:(e,t,a)=>{a.d(t,{b:()=>r});var o=a(86955);function r(e){e.code.add(o.H`vec3 tonemapACES(vec3 x) {
return clamp((x * (2.51 * x + 0.03)) / (x * (2.43 * x + 0.59) + 0.14), 0.0, 1.0);
}`)}},62026:(e,t,a)=>{a.d(t,{M:()=>r});var o=a(86955);function r(e){e.vertex.code.add(o.H`vec4 offsetBackfacingClipPosition(vec4 posClip, vec3 posWorld, vec3 normalWorld, vec3 camPosWorld) {
...
return outColor;
}`)}}},68745:(e,t,a)=>{a.d(t,{D:()=>j,b:()=>B});var o=a(62026),r=a(34981),i=a(26917),n=a(59395),s=a(35771),l=a(45937),c=a(85793),d=a(59046),u=a(22148),h=a(97808),m=a(54478),v=a(55386),p=a(25530),f=a(15710),g=a(72937),x=a(9365),b=a(66970),w=a(43557),y=a(27920),M=a(42953),T=a(26719),C=a(51740),S=a(94192),_=a(55696),H=a(66763),z=a(37516),N=a(77904),I=a(3799),O=a(5517),F=a(58350),E=a(21390),L=a(86955),R=a(70367),G=a(34260),V=a(99362),A=a(91911),P=a(2687),D=a(75569);function B(e){const t=new P.N5,{attributes:a,vertex:B,fragment:j,varyings:W}=t,{output:U,normalType:k,offsetBackfaces:Y,spherical:Z,snowCover:q,pbrMode:J,textureAlphaPremultiplied:$,instancedDoublePrecision:X,hasVertexColors:K,hasVertexTangents:Q,hasColorTexture:ee,hasNormalTexture:te,hasNormalTextureTransform:ae,hasColorTextureTransform:oe}=e;if((0,I.NB)(B,e),a.add("position","vec3"),W.add("vpos","vec3",{invariant:!0}),t.include(H.A,e),t.include(l.B,e),t.include(p.Ge,e),t.include(_.q2,e),!(0,r.RN)(U))return t.include(f.E,e),t;t.include(_.Sx,e),t.include(_.MU,e),t.include(_.O1,e),t.include(_.QM,e),(0,I.yu)(B,e),t.include(d.Y,e),t.include(n.d);const re=0===k||1===k;return re&&Y&&t.include(o.M),t.include(g.W,e),t.include(v.Mh,e),t.include(s.v,e),W.add("vPositionLocal","vec3"),t.include(h.U,e),t.include(u.K,e),t.include(m.c,e),B.uniforms.add(new F.E("externalColor",e=>e.externalColor,{supportsNaN:!0})),W.add("vcolorExt","vec4"),t.include(S.Z,e),B.include(c.WD),B.include(c.oF),t.include(X?C.G:C.Bz,e),B.main.add(L.H`
    forwardNormalizedVertexColor();
  ...
  `),t}const j=Object.freeze(Object.defineProperty({__proto__:null,build:B},Symbol.toStringTag,{value:"Module"}))},72937:(e,t,a)=>{a.d(t,{W:()=>u});var o=a(44680),r=a(72745),i=a(95352),n=a(95756),s=a(86955),l=a(72106),c=a(27374),d=a(70367);function u(e,t){const a=e.fragment,{hasVertexTangents:u,doubleSidedMode:h,hasNormalTexture:m,textureCoordinateType:v,bindType:p,hasNormalTextureTransform:f}=t;u?(e.attributes.add("tangent","vec4"),e.varyings.add("vTangent","vec4"),2===h?a.code.add(s.H`mat3 computeTangentSpace(vec3 normal) {
...
rawNormal.xy = (normalRotation * vec3(rawNormal.x, rawNormal.y, 1.0)).xy;`),a.code.add(s.H`return tangentSpace * rawNormal;
}`))}},77904:(e,t,a)=>{a.d(t,{N:()=>i});var o=a(80883),r=a(86955);function i(e){e.include(o.a),e.code.add(r.H`
  ...
  `)}},78992:(e,t,a)=>{a.d(t,{Bt:()=>s,Jr:()=>i,SY:()=>l,mb:()=>n});var o=a(20664),r=a(9392);function i(e){let{normalTexture:t,metallicRoughnessTexture:a,metallicFactor:i,roughnessFactor:n,emissiveTexture:s,emissiveFactor:l,occlusionTexture:c}=e;return null==t&&null==a&&null==s&&(null==l||(0,o.q)(l,r.uY))&&null==c&&(null==n||1===n)&&(null==i||1===i)}const n=(0,r.CN)(1,1,.5),s=(0,r.CN)(0,.6,.2),l=(0,r.CN)(0,1,.2)}}]);
//# sourceMappingURL=5131.f6dcd588.chunk.js.map